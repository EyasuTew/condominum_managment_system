    ...
    <script type = "text/javascript" language = "javascript">
         $(document).ready(function() {
         	...
         	$("#txtsearch").change(function(event){
         			...
         			var maritalid = $("#txtsearch").val();
					if(maritalid_validator(maritalid) && (maritalid!=""))
					{
					...
					}else if(maritalid=="")
					{
						...
						document.getElementById('maritalid_validation_feedback').innerHTML='<b><p style="color:red;">Empty marital id</p></b>';
						searchElement.focus();
					}
					else
					{
						document.getElementById('searchdiv').className='form-group has-error';
						document.getElementById('maritalid_validation_feedback').innerHTML='<b><p style="color:red;">Invalid marital id</p></b>';
						searchElement.focus();
					}
         	});
            ...
            $("#searchbtn").click(function(event){
            	$("#searchdisplaydiv").empty();
					...
					if(maritalid_validator(maritalid) && (maritalid!=""))
					{
						$("#searchdisplaydiv").load('../../controller/resident/maritalsearchfordelete.php', {"maritalid":maritalid} );
					}else
					{
				...
				<div class="row">
					...
					<div class="col-md-7 col-xs-12" style="border:1px solid #c0c0c0; min-height:550px">
						<form class="form-horizontal">
							<center></br><p class="actiontitel">Delete Marital infromation</p></br></hr>
							</center>
							<div class="form-group" id="searchdiv">
	                                ...
	                                <label class="control-label col-offset-1 col-xs-4" for="txtsearch">Marital Id:</label>
	                                <div class="col-xs-6">
		                                <input type="text" class="form-control" placeholder="Marital id..." id="txtsearch" name="txtsearch">
		                            </div>
		                             <div class="col-xs-2">
	                            ...
	                            <div class="valid-feedback col-xs-offset-4" id="maritalid_validation_feedback"></div>
	                           </div> 
