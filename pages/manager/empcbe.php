				...
				<div class="row">
					<div class="col-md-2 col-xs-12" >
						<div class="nav nav-pills nav-stacked fixed-top hidden-xs hidden-sm" style="position: fixed; width:15%; border:1px solid #c0c0c0; ">
							<li class="onactiveside onhoveside">
								<a href="empbsc.php" class="" style="color: black;"><b>News</b></a>
							</li>
							<li class="onhoveside">
								<a href="updateresident.php" class="" style="color: black;"><b>Update applicant</b></a>
							</li>
							<li class="onhoveside">
					...
					<form class="form-horizontal">
						...
						<div class="form-group" id="newstitlediv">
							...
							<div class="col-xs-7">
								<taxtarea id="newstitletextarea"></taxtarea>
							</div>
