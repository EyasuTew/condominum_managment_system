		...
		<div class="row">
			...
			<div class="col-md-12 col-xs-12">
				<div class="row">
					...
					<form name="newsform" id="newsform" class="form-horizontal" enctype="multipart/form-data">
						<center></br>
							<p class="actiontitel">Post news</p></br></hr>
						</center>

						<div class="form-group" id="newstitlediv">
							<label class="control-label col-xs-4" for="newstitletextarea">News title:</label>
							<div class="col-xs-7">
								<textarea cols="58" rows="3" name="newstitletextarea" id="newstitletextarea"></textarea>
							</div>
							<div class="col-xs-1"></div>
							<div class="valid-feedback col-md-offset-5 col-xs-6" id="newstitle_validation_feedback"></div>
						</div>

						<div class="form-group" id="newspartdiv">
							<label class="control-label col-xs-4" for="newsparttextarea">News part:</label>
							<div class="col-xs-7">
								<textarea cols="58" rows="13" name="newsparttextarea" id="newsparttextarea"></textarea>
							</div>
							<div class="col-xs-1"></div>
							<div class="valid-feedback col-md-offset-5 col-xs-6" id="newspart_validation_feedback"></div>
						</div>

						<div class="form-group" id="newsmediadiv">
							<label class="control-label col-xs-4" for="newsmediafile">News media:</label>
							<div class="col-xs-7">
								<input type="file" class="form-control" id="newsmediafile" name="newsmediafile">
							</div>
							<div class="col-xs-1"></div>
							<div class="valid-feedback col-md-offset-5 col-xs-6" id="newsmedia_validation_feedback"></div>
						</div>
							...
							<div class="form-group">
								<div class="col-xs-offset-3 col-xs-8">
									<div class="col-xs-6">
										<input type="submit" class="btn btn-primary  btn-block" id="savebtn" name="savebtn" value="Save">
									</div>
