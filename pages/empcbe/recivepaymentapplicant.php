         ...
         $(document).ready(function() {
            ...
            $("#searchbtn").click(function(event){
            	$("#searchdisplaydiv").empty();
					...
					if(applicantid_validator(applicantid) && (applicantid!=""))
					{
						$("#searchdisplaydiv").load('../../controller/applicant/applicantsearchforrecivepayment.php', {"applicantid":applicantid} );
					}else
					{
						//alert("dbgh");
					}
				...
				<div class="row">
					...
					<div class="col-md-7 col-xs-12" style="border:1px solid #c0c0c0; min-height:550px">
						<form class="form-horizontal">
							<center></br><p class="actiontitel">Receive  payment</p></br></hr>
							</center>
